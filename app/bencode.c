...
static void print_int(d_res_t* decoded_str, int iter) {
    printf("%ld", decoded_str->data.v_list->data[iter]->data.v_long);  
}

static void print_str(d_res_t* decoded_str, int iter) {
    printf("\"%s\"", decoded_str->data.v_list->data[iter]->data.v_str);
}

static void print_dict(d_res_t*);

static void print_list(d_res_t* decoded_str) {
    printf("[");
...
static void print_dict(d_res_t* decoded_str) {
